...
export const GlobalDataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    return (
        <GlobalDataContext.Provider value={{ data, loading, isOffline, refreshAll, refreshProfile, refreshTasks, refreshAudits, refreshContactsCorporate, refreshContactsPersonal }}>
            {children}
