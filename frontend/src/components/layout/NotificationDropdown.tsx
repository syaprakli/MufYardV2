...
const getIcon = (type: string) => {
    ...
    return (
        <div className="absolute top-full right-[-60px] sm:right-0 mt-4 w-[calc(100vw-32px)] sm:w-[400px] bg-white/90 backdrop-blur-xl border border-slate-200 rounded-3xl shadow-2xl shadow-slate-200/50 overflow-hidden z-[60] animate-in fade-in slide-in-from-top-2 duration-200">
            {/* Header */}
