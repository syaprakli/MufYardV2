...
export default function DenetimBilgiBankasi() {
    ...
    const activeTab = "bilgi_bankasi" as string;
    const setActiveTab = (tab: string) => {
        if (tab !== "bilgi_bankasi") {
                ...
                <div className="flex items-center gap-3.5">
                    ...
                    <div>
                        <div className="flex items-center gap-1.5 text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">
                            ...
                            <ChevronRight size={8} />
                            <span className="text-blue-500 font-bold">AI Bilgi Bankası</span>
                        </div>
                        <h1 className="text-lg font-black text-slate-900 dark:text-white tracking-tight mt-0.5">AI Bilgi Bankası</h1>
                    </div>
                </div>
            </div>
                                            ...
                                            return (
                                                <div className="flex flex-col items-center justify-center py-12 text-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-slate-400 mt-1">Seçili denetim türünde görev görünmüyor.</p>
                                                    </div>
                                                </div>
                                            );
                                        }
