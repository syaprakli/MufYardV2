...
export default function DenetimOzel() {
    ...
    const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            savePhotoToLocalDevice(file, `Ozel_${selectedReport?.title || "Denetim"}`);
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {photos.length > 0 && (
                            <button
                                type="button"
                                onClick={() => exportPhotosToComputer(photos, `${selectedReport?.title || "Ozel_Denetim"}_Fotograflar`)}
                            ...
                            return (
                                ...
                                >
                                    <div className="relative aspect-video sm:aspect-square overflow-hidden bg-slate-100 dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => exportPhotosToComputer([url], `${selectedReport?.title || "Ozel_Denetim"}_Foto_${index + 1}`)}
                ...
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        <div className="flex items-center gap-1.5 text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">
                            ...
                            <ChevronRight size={8} />
                            <span className="text-blue-500 font-bold truncate">Özel Yurt Denetimi</span>
                        </div>
                        <h1 className="text-base sm:text-lg font-black text-slate-900 dark:text-white tracking-tight mt-0.5 truncate">Özel Yurt Denetimi</h1>
                    </div>
                </div>
