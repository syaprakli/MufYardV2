                        ...
                        {!selectedTask ? (
                            ...
                            <div className="flex-1 flex flex-col gap-6 overflow-y-auto pr-1">
                                ...
                                <div className="flex-1 flex flex-col overflow-y-auto">
                                    ...
                                    {activeDetailTab !== "dashboard" && activeDetailTab !== "evrak_talebi" && !selectedReport ? (
                                        <div className="flex-1 flex flex-col items-center justify-center border border-dashed border-slate-200 dark:border-slate-800 rounded-xl p-8 text-center gap-4 min-h-[300px]">
                                            ...
                                            <Button
                                                ...
                                                className="px-6 h-11 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl flex items-center gap-2 shadow-lg shadow-blue-500/20 w-full sm:w-auto justify-center"
                                            >
