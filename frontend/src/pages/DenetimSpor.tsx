            ...
            <div className={`flex flex-col sm:flex-row sm:items-center gap-4 bg-white dark:bg-slate-900/30 backdrop-blur-md border border-slate-100 dark:border-slate-900/50 rounded-2xl p-4 flex-shrink-0 justify-between shadow-sm ${activeDetailTab !== "hub" ? "hidden" : "flex"}`}>
                <div className="flex items-center gap-3.5">
                    <button
                        ...
                        className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-955 border border-slate-200 dark:border-slate-800 text-slate-500 hover:text-slate-700 dark:hover:text-slate-350 hover:bg-slate-200 dark:hover:bg-slate-900 flex items-center justify-center transition-all duration-200"
                    ...
                    <div>
                        <div className="flex items-center gap-1.5 text-[9px] font-black uppercase tracking-[0.2em] text-slate-400">
                            ...
                            <ChevronRight size={8} />
                            <span className="text-blue-500 font-bold">Spor Kulüpleri Denetimi</span>
                        </div>
                        <h1 className="text-lg font-black text-slate-900 dark:text-white tracking-tight mt-0.5">Spor Kulüpleri Denetimi</h1>
                    </div>
                </div>
