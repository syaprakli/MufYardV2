...
export default function DenetimFederasyon() {
    ...
    const activeTab = "federasyon" as string;
    ...
    // Bu sayfa YALNIZCA Federasyon Denetimi sayfasi oldugu icin soru seti daima federasyon'dur!
    const taskTabId = "federasyon";

    // Questions answered by the user for preview modal
    const previewQuestions = useMemo(() => {
        const questions = AUDIT_TEMPLATES.federasyon || [];
                                                ...
                                                <div className="flex flex-col items-center justify-center py-12 text-center gap-3">
                                                    ...
                                                    <div className="flex flex-col gap-1 items-center">
                                                        ...
                                                        <p className="text-xs text-slate-400 mt-1 max-w-sm leading-relaxed">
                                                            Seçili denetim türünde (Federasyon Denetimi) henüz bir görev oluşturulmamıştır. Denetime başlamak için önce "Görevler" sayfasından bu türde bir görev oluşturmalısınız.
                                                        </p>
                                                    </div>
                                                    <Button
                                                        onClick={() => {
