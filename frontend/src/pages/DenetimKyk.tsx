...
export default function DenetimKyk() {
    ...
    const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            savePhotoToLocalDevice(file, `KYK_${selectedReport?.title || "Denetim"}`);
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {photos.length > 0 && (
                            <button
                                type="button"
                                onClick={() => exportPhotosToComputer(photos, `${selectedReport?.title || "KYK_Denetimi"}_Fotograflar`)}
                            ...
                            return (
                                ...
                                >
                                    <div className="relative aspect-video sm:aspect-square overflow-hidden bg-slate-100 dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => exportPhotosToComputer([url], `${selectedReport?.title || "KYK_Denetimi"}_Foto_${index + 1}`)}
