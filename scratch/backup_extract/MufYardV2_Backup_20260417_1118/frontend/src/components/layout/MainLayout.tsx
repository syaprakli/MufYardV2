...
export function MainLayout() {
    return (
        <div className="h-screen w-full flex bg-slate-50 overflow-hidden font-outfit">
            <Sidebar />
            ...
            <main className="flex-1 ml-64 flex flex-col min-w-0 relative h-full pt-16">
                ...
                <div className="flex-1 overflow-y-auto relative bg-slate-50 scrollbar-none px-8 py-8">
                    <Outlet />
                </div>
            </main>
        </div>
